...
ylimE0m <- range(e0obs_CHEmales,e0obs_SWEmales,e0_STAD_CHEmales,e0_STAD_SWEmales)
ylimG0m <- range(g0obs_CHEmales,g0obs_SWEmales,g0_STAD_CHEmales,g0_STAD_SWEmales,
                 g0_CODA_CHEmales)
ylimE0f <- range(e0obs_CHEfemales,e0obs_SWEfemales,e0_STAD_CHEfemales,e0_STAD_SWEfemales)
ylimG0f <- range(g0obs_CHEfemales,g0obs_SWEfemales,g0_STAD_CHEfemales,g0_STAD_SWEfemales,
                 g0_CODA_CHEfemales)
...
op <- par(mfrow = c(2,2),
          oma = c(2,2,0,0) + 0.1,
          mar = c(1,1.75,1,1) + 0.1)
## bottom, left, top, right
## E0 - FEM
plot(years,e0obs_CHEfemales,t="n",main="Life Expectancy - Females",ylim=ylimE0f,xlim=range(years,years.fore),
...
points(years,e0obs_CHEfemales,pch=1,col=col.obs[1])
points(years,e0obs_SWEfemales,pch=5,col=col.obs[2])
...
legend("topleft",c("Switzerland","Sweden"),col=col.obs,pch=c(1,5),bty="n",
       cex=cex.leg)

## E0 - MAL
plot(years,e0obs_CHEmales,t="n",main="Life Expectancy - Males",ylim=ylimE0m,xlim=range(years,years.fore),
     xlab="",ylab="",axes=F,cex.main=cex.main)
axis(1,at=seq(1960,2040,20),labels = rep("",5))
axis(2,las=2,cex.axis=cex.y.axis)
grid();box()
points(years,e0obs_CHEmales,pch=1,col=col.obs[1])
points(years,e0obs_SWEmales,pch=5,col=col.obs[2])
...
## G0 - FEM
plot(years,g0obs_CHEfemales,t="n",main="Gini - Females",ylim=ylimG0f,xlim=range(years,years.fore),
     xlab="",ylab="",axes=F,cex.main=cex.main)
...
mtext(text = expression(g[0]),side=2,
      line = 1.75,cex=cex.y.lab,las=1)
points(years,g0obs_CHEfemales,pch=1,col=col.obs[1])
...
## G0 - MAL
plot(years,g0obs_CHEmales,t="n",main="Gini - Males",ylim=ylimG0m,xlim=range(years,years.fore),
     xlab="",ylab="",axes=F,cex.main=cex.main)
axis(1,at=seq(1960,2040,20))
axis(2,las=2,cex.axis=cex.y.axis)
grid();box()
points(years,g0obs_CHEmales,pch=1,col=col.obs[1])
points(years,g0obs_SWEmales,pch=5,col=col.obs[2])
...
legend("topright",c("Switzerland","Sweden"),col=col.obs,pch=c(1,5),bty="n",
       cex=cex.leg)
par(mfrow=c(1,1))
