...
\begin{landscape}
	...
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} &  \multicolumn{1}{c|}{\cellcolor{my-grey}}  & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & \textbf{0.11}  & 0.29   & 0.40  & 0.16   & 100\% & 100\% & 100\% & \textbf{90\%} & -1.44  &  -1.03  &  \textbf{-0.72} & -2.15 \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & 0.08 & 0.11   & 0.09 & \textbf{0.06}   & 100\% &  \textbf{80\%}  & 90\% & \textbf{80\%}  & -4.12  &  \textbf{-2.83} &    -2.89 & 3.98   \\
	\rowcolor{my-grey} 
	...
	\hhline{~|---------------|}
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & 0.13  & \textbf{0.11}   & 0.39  &  0.12   & 100\% & 100\% & 100\% & \textbf{95\%} & -0.54  &   \textbf{-0.51} &   -0.51 &  -2.13 \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & 0.08  & \textbf{0.06} & 0.21  & 0.10 & 90\% & 100\% & 95\% & \textbf{85\%} & -3.49 &   -2.73 & \textbf{-2.08} & -3.13 \\
	\rowcolor{my-white} 
	...
	\hhline{~|---------------|}
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & 0.74 & 0.43  & 0.45  & \textbf{0.20}   & \textbf{87\%} & 100\% & 97\% & 93\% & 0.22 &   \textbf{0.08}  & -0.64 & -0.96    \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & 0.21 & 0.40 & 0.30 & \textbf{0.13} & 70\%   & 63\% &  37\%  & \textbf{77\%}  & -0.76  &  \textbf{-0.03}  & -1.10  & -2.82  \\
	\rowcolor{my-grey} 
	...
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &     \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & \textbf{0.19} & 0.41  & 0.34  & 0.78   & 100\% & \textbf{90\%} & 100\% & 0\% & -1.44  &  -0.72 &  \textbf{-0.32} &  3.96  \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &     \multicolumn{1}{c|}{\cellcolor{my-white}}                 & \multicolumn{1}{c|}{\cellcolor{my-white}}    & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & 0.13  & 0.21  & \textbf{0.12}  & 0.26   & \textbf{80\%} & 70\% & 100\% & 10\% & -3.16  &  -2.02  & -2.29 & \textbf{1.23}  \\
	\rowcolor{my-white} 
	...
	\hhline{~|---------------|}
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &         \multicolumn{1}{c|}{\cellcolor{my-grey}}             & \multicolumn{1}{c|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & \textbf{1.39} & 1.59  & 1.61 & 2.23  & 10\% & 20\%  & \textbf{25\%} & 0\% & 2.82   & 3.14 &  \textbf{2.65} &  43.43    \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &      \multicolumn{1}{c|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-grey}}   & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & \textbf{0.46} & 0.74  & 0.65 & 1.01   & 15\% & 0\%  & \textbf{20\%} & 0\% & \textbf{0.90}  &  6.38  & 1.52 & 51.82  \\
	\rowcolor{my-grey} 
	...
	\hhline{~|---------------|}
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &   \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & \textbf{1.55} & 1.63  & 2.27  & 1.94  & 37\% & \textbf{47\%} & 30\% & 17\% & 3.90 &   \textbf{2.39} & 4.04 &  31.51 \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &  \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & 0.98 & \textbf{0.64} &  0.88  & 0.71  & 20\% & \textbf{27\%} & \textbf{27\%} & 17\% & 3.10  &  \textbf{1.84} &  3.31 & 39.06  \\
	\rowcolor{my-white} 
	...
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} &  \multicolumn{1}{c|}{\cellcolor{my-grey}}  & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & 0.12   & \textbf{0.10}    & 0.38   & 0.15  & \textbf{100\%} & \textbf{100\%} & \textbf{100\%} & \textbf{100\%} & -2.27  &  -1.56 &  \textbf{-0.59} & -2.27 \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & 0.07   & \textbf{0.05}    & 0.13  & 0.12   & \textbf{80\%} & 90\% & 100\% & 50\% & -4.16  & -3.67  & -2.75 &  \textbf{-2.33}    \\
	\rowcolor{my-grey} 
	...
	\hhline{~|---------------|}
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & 0.46   &  \textbf{0.17}    & 0.73  & 0.46 & \textbf{90\%} & 100\% & 95\% & 20\% & -0.82  &  -0.68 &  0.28 & \textbf{-0.04} \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & \textbf{0.06}  & 0.10    & 0.20   & \textbf{0.06} & 95\% & 90\% & 95\% & \textbf{85\%} & -3.92 &   -2.69 &  \textbf{-2.20} & -4.00 \\
	\rowcolor{my-white} 
	...
	\hhline{~|---------------|}
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & 0.69    & 0.53    & 1.43     & \textbf{0.43}   & 23\% & \textbf{97\%} & 7\% & 30\% & 0.92 &   -0.11 & 8.16 & \textbf{0.02}    \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & \textbf{0.07}  &  \textbf{0.07}    & 0.34     & 0.09   & \textbf{80\%} & 87\% & 20\% & 70\% & -2.31 &  -2.72 & \textbf{1.87} &  -3.59  \\
	\rowcolor{my-grey} 
	...
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &     \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & \textbf{0.11}  & 0.38   & 0.41    & 0.81  & \textbf{100\%} & \textbf{100\%} & \textbf{100\%} & 0\% & -1.65 &  -0.95 &   \textbf{-0.90}  & 4.72  \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &     \multicolumn{1}{c|}{\cellcolor{my-white}}                 & \multicolumn{1}{c|}{\cellcolor{my-white}}    & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & 0.10   & 0.09    & \textbf{0.03}  & 0.04 & \textbf{70\%} & \textbf{90\%} & 100\% & 100\% & -3.48 &   \textbf{-3.04} & -3.51 &  -4.13  \\
	\rowcolor{my-white} 
	...
	\hhline{~|---------------|}
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}}  & \multicolumn{1}{c|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & \textbf{0.72}   & 1.35     & 1.34   & 1.69 & \textbf{100\%} & 30\% & 15\% & 0\% & \textbf{0.20}  &  2.27 &  5.28 &  16.06  \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &      \multicolumn{1}{c|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-grey}}   & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & 0.32   & 0.37     & \textbf{0.26}    & 0.39 & 15\% & 10\% & \textbf{40\%} & 0\% & \textbf{-0.17}  &  -0.19  & -0.90  & 1.50  \\
	\rowcolor{my-grey} 
	...
	\hhline{~|---------------|}
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &   \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & 2.65 & \textbf{2.43}   & 2.59    & 3.14   & 7\% & \textbf{13\%} & 7\% & 0\% & 18.49 &  \textbf{7.64} & 72.16 & 149.89 \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &  \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & \textbf{0.40}    & 0.83    & 0.93    & 1.02   & \textbf{23\%} & 17\% & 10\% & 10\% & \textbf{0.01} & 10.40 &  67.76 & 76.51  \\
	\rowcolor{my-white} 
	...
	\end{tabular}
	\caption{Mean absolute error (MAE), empirical coverage probability (ECP) for the 80\% PI, and mean Dawid-Sebastiani score (DSS) of the 3C-STAD, LC, CODA and HU forecasts of $e^{0}$, $g^{0}$ and $\ln(m_{x,t})$ for females and males in two countries and three out-of-sample exercises: validation periods of 10 years (training period 1950-2006), 20 years (1950-1996) and 30 years (1950-1986). Lower values of the MAE and of the DSS (in bold) correspond to greater forecast accuracy. Values of the ECP closer to the 80\% nominal level (in bold) correspond to greater interval forecast accuracy.\\\footnotesize{\textit{Source}: as for Figure \ref{Fig:Intro}.}}\label{Table:Validation}
	\end{table}
