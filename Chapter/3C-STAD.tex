...
\begin{landscape}
	...
	& \multicolumn{4}{c}{{\color{red}\textbf{Probabilistic forecast} (DSS)}} \\ 
	...
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} &  \multicolumn{1}{c|}{\cellcolor{my-grey}}  & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & \textbf{0.13}  & 0.34   & 0.37  & 0.15   & 100\% & 100\% & 100\% & \textbf{90\%} & 1.13  &  1.52  &  1.58 & \textbf{1.08} \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} &\textbf{0.07} & 0.13   & 0.09 & \textbf{0.07}   & 100\% &  70\%  & 100\% & \textbf{80\%}  & 0.93  &  1.36 &    \textbf{0.69} & 1.11   \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}1950-2006}} &  \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}10y}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$\ln(m_{x,t})$}      & \textbf{0.19} & 0.24  & 0.24  & 0.22   & 39\% & 32\% & \textbf{50\%} & 36\% & 24.17 & 45.47 & 62.87 & \textbf{11.42} \\ 
	\hhline{~|---------------|}
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & 0.13  & 0.13   & 0.36  &  \textbf{0.12}   & 100\% & 100\% & 100\% & \textbf{95\%} & 1.60  &   1.90 &   1.64 &  \textbf{0.92} \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & 0.08  & \textbf{0.07} & 0.21  & 0.11 & 90\% & 100\% & 95\% & \textbf{85\%} & 0.99 &   \textbf{0.69} & 1.19 & 1.28 \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}{1950-1996}}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}{20y}}} & \multicolumn{1}{c|}{\cellcolor{my-white}$\ln(m_{x,t})$}      & \textbf{0.19} & 0.24  & 0.23 & 0.23   & 48\% & 51\% & \textbf{52\%} & 38\% & 17.98  & 37.58 & 43.93 & \textbf{9.61}  \\ 
	\hhline{~|---------------|}
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & 0.82 & 0.53  & 0.48  & \textbf{0.16}   & \textbf{77\%} & 100\% & 87\% & 93\% & 2.68 &   2.31  & 1.92 & \textbf{1.29}    \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & 0.21 & 0.43 & 0.32 & \textbf{0.13} & 70\%   & 63\% &  23\%  & \textbf{80\%}  & 2.74  &  2.91  & 2.7  & \textbf{1.39}  \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\multirow{-9}{*}{\cellcolor{my-grey}\thead{Switzerland \\ Females}}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}1950-1986}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}30y}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$\ln(m_{x,t})$}      & 0.22 & 0.29   & 0.23 & \textbf{0.20} & 51\% & 49\% & \textbf{57\%}  & 41\% & 14.8 & 18.91 & 24.37 & \textbf{8.51}  \\ 	\midrule
	
	%% CHE Males
	
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &     \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & \textbf{0.16} & 0.37  & 0.29  & 0.77   & \textbf{100\%} & \textbf{100\%} & \textbf{100\%} & 0\% & \textbf{1.02}  &  1.54 &  1.82 &  6.27  \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &     \multicolumn{1}{c|}{\cellcolor{my-white}}                 & \multicolumn{1}{c|}{\cellcolor{my-white}}    & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & 0.12  & 0.20  & \textbf{0.11}  & 0.26   & 50\% & \textbf{70\%} & 100\% & 10\% & 1.81  &  1.81  & \textbf{0.84} & 6.05  \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}1950-2006}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}10y}} & \multicolumn{1}{c|}{\cellcolor{my-white}$\ln(m_{x,t})$} & \textbf{0.17}   & 0.23  & 0.20 &  0.20   & 34\% & 31\% & \textbf{53\%} & 31\% & 17.7  &  470.76 & 76.26 & \textbf{8.61}  \\ 
	\hhline{~|---------------|}
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &         \multicolumn{1}{c|}{\cellcolor{my-grey}}             & \multicolumn{1}{c|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & \textbf{1.40} & 1.61  & 1.57 & 2.23  & 10\% & \textbf{25\%} & 20\%  &  0\% & 5.52   & \textbf{4.63} &    4.92 &  43.36    \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &      \multicolumn{1}{c|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-grey}}   & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & \textbf{0.45} & 0.74  & 0.62 & 1.01   & \textbf{15\%} & 5\%  & \textbf{15\%} & 0\% & \textbf{4.44}  &  7.6  &    4.95 & 62.77  \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}{1950-1996}}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}{20y}}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$\ln(m_{x,t})$} & \textbf{0.25} & 0.29  & 0.28 & 0.32   & 28\% & 33\% & \textbf{41\%}  & 17\% & \textbf{17.39} &  132614 & 67.03 & 21.19 \\ 
	\hhline{~|---------------|}
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &   \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & 1.60 & \textbf{1.58}  & 2.14  & 1.93  & 33\% & \textbf{43\%} & 33\% & 17\% & 6.74 &   \textbf{4.28} & 5.9 &  32.63 \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &  \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & 0.98 & \textbf{0.62} &  0.86  & 0.70  & 17\% & \textbf{23\%} & \textbf{23\%} & 20\% & 7.11  &  \textbf{4.38} &  6.35 & 43.06  \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\multirow{-9}{*}{\cellcolor{my-white}\thead{Switzerland \\ Males}}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}1950-1986}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}30y}} & \multicolumn{1}{c|}{\cellcolor{my-white}$\ln(m_{x,t})$} & 0.32 & \textbf{0.27} & 0.30 & \textbf{0.27} & 22\% & 38\% & \textbf{44\%} & 21\% & \textbf{18.80} &   98.14 & 25.89 & 23.44  \\ \midrule
	
	%% SWE Females %% SWE Females %% SWE Females
	%% SWE Females %% SWE Females %% SWE Females
	
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} &  \multicolumn{1}{c|}{\cellcolor{my-grey}}  & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & \textbf{0.12}   & \textbf{0.12}    & 0.39   & 0.16  & 100\% & 100\% & 100\% & \textbf{90\%} & \textbf{0.82}  &  0.97 &  1.59 & 1.04 \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & 0.07   & \textbf{0.05}    & 0.12  & 0.12   & \textbf{80\%} & 90\% & 100\% & 50\% & 1.08  & \textbf{0.76}  & 0.79 &  2.82    \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}1950-2006}} &  \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}10y}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$\ln(m_{x,t})$} & \textbf{0.16}  & 0.18   & 0.22   & \textbf{0.16}   & 37\% & 37\%  & \textbf{53\%} & 42\% & 23.78 &  722.94 & 85.01 & \textbf{9.61} \\ 
	\hhline{~|---------------|}
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & 0.45   &  \textbf{0.16}    & 0.74  & 0.44 & 100\% & 100\% & \textbf{75\%} & 20\% & 1.64  &  \textbf{1.55} &  2.53 & 3.06 \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & \textbf{0.07}  & 0.10    & 0.20   & \textbf{0.07} & 100\% & 90\% & \textbf{80\%} & 75\% & \textbf{0.66} &   1.11 &  1.23 & 1.11 \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}{1950-1996}}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}{20y}}} & \multicolumn{1}{c|}{\cellcolor{my-white}$\ln(m_{x,t})$} & \textbf{0.17} & 0.19  & 0.22 & 0.19 & 49\% & 46\% & \textbf{50\%} & 26\% & 23.88  & 183.75 & 95.01 &  \textbf{13.61} \\ 
	\hhline{~|---------------|}
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & 0.69    & 0.49    & 1.56     & \textbf{0.46}   & 27\% & \textbf{97\%} & 7\% & 30\% & 3.32 &   \textbf{2.04} & 12.52 & 3.28    \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-grey}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & 0.09  &  \textbf{0.08}    & 0.40     & \textbf{0.08}   & \textbf{83\%} & 87\% & 13\% & 67\% & 1.25 &   \textbf{0.91} & 6.41 &  1.63  \\
	\rowcolor{my-grey} 
	\multicolumn{1}{c|}{\multirow{-9}{*}{\cellcolor{my-grey}\thead{Sweden \\ Females}}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}1950-1986}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}30y}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$\ln(m_{x,t})$} & \textbf{0.18} & 0.21   & 0.28   & 0.19 & 38\% & \textbf{39\%} & 30\% & 28\% & \textbf{16.82} &  28.48 & 118.27 & 17.34 \\ \midrule
	...
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &     \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & \textbf{0.10}  & 0.36   & 0.49    & 0.81  & 100\% & 90\% & \textbf{80\%} & 0\% & \textbf{1.04} &   1.70 &    1.98  & 7.84  \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &     \multicolumn{1}{c|}{\cellcolor{my-white}}                 & \multicolumn{1}{c|}{\cellcolor{my-white}}    & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & 0.09   & 0.10    & \textbf{0.04}  & \textbf{0.04} & \textbf{80\%} & 90\% & 100\% & 100\% & 1.07 &   0.98 &  0.47 &  \textbf{0.38}  \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}1950-2006}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}10y}} & \multicolumn{1}{c|}{\cellcolor{my-white}$\ln(m_{x,t})$} &  \textbf{0.17}   & 0.23    &  0.19  &  0.18 & 42\% & 23\% & \textbf{43\%} & 26\% & 34.54  & 135.55 & 181.28 & \textbf{11.76}  \\ 
	\hhline{~|---------------|}
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &  \multicolumn{1}{c|}{\cellcolor{my-grey}}  & \multicolumn{1}{c|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-grey}$e^{0}$} & \textbf{0.71}   & 1.38     & 1.30   & 1.76 & \textbf{100\%} & 20\% & 10\% & 0\% & \textbf{2.62}  &  4.72 &  7.46 &  22.98  \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &      \multicolumn{1}{c|}{\cellcolor{my-grey}}    & \multicolumn{1}{c|}{\cellcolor{my-grey}}   & \multicolumn{1}{c|}{\cellcolor{my-grey}$g^{0}$} & 0.35   & 0.38     & \textbf{0.25}    & 0.42 & 25\% & 10\% & \textbf{40\%} & 0\% & 3.94  &  3.57  & \textbf{3.01}  & 6.94  \\
	\rowcolor{my-grey} 
	\multicolumn{1}{l|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}{1950-1996}}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-grey}{20y}}} & \multicolumn{1}{c|}{\cellcolor{my-grey}$\ln(m_{x,t})$} & \textbf{0.20} & 0.29  & 0.23 & 0.22 & \textbf{50\%} & 22\% & 31\% & 25\% & \textbf{12.45}  & 137.07 & 77.48 & 13.86 \\ 
	\hhline{~|---------------|}
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &   \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}} & \multicolumn{1}{c|}{\cellcolor{my-white}$e^{0}$} & 2.74   & \textbf{2.46}   & 2.58    & 3.12   & 7\% & \textbf{23\%} & 7\% & 0\% & 20.53 &  \textbf{8.82} & 55.03 & 154.3 \\
	\rowcolor{my-white} 
	\multicolumn{1}{l|}{\cellcolor{my-white}}    &  \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}}  & \multicolumn{1}{c|}{\cellcolor{my-white}$g^{0}$} & \textbf{0.44}    & 0.83    & 0.89    & 1.02   & 17\% & \textbf{20\%} & 10\% & 10\% & \textbf{4.53} & 9.56 &  44.45 & 83.94  \\
	\rowcolor{my-white} 
	\multicolumn{1}{c|}{\multirow{-9}{*}{\cellcolor{my-white}\thead{Sweden \\ Males}}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}1950-1986}} & \multicolumn{1}{c|}{\multirow{-3}{*}{\cellcolor{my-white}30y}} & \multicolumn{1}{c|}{\cellcolor{my-white}$\ln(m_{x,t})$} & \textbf{0.30}  & 0.37  & 0.31  & 0.31 & 17\% & \textbf{31\%} & 25\% & 16\% & \textbf{24.16} &  79.65 & 62.96 & 50.87  \\ 
	
	\bottomrule 
				
	\end{tabular}
	\caption{Mean absolute error (MAE), empirical coverage probability (ECP) for the 80\% PI, {\color{red}and  Dawid-Sebastiani score (DSS)} of the 3C-STAD, LC, CODA and HU forecasts of $e^{0}$, $g^{0}$ and $\ln(m_{x,t})$ for females and males in two countries and three out-of-sample exercises: validation periods of 10 years (training period 1950-2006), 20 years (1950-1996) and 30 years (1950-1986). Lower values of the MAE {\color{red}and of the DSS} (in bold) correspond to greater forecast accuracy. Values of the ECP closer to the 80\% nominal level (in bold) correspond to greater interval forecast accuracy.\\\footnotesize{\textit{Source}: as for Figure \ref{Fig:Intro}.}}\label{Table:Validation}
	\end{table}
